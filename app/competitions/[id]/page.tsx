...
export default function CompetitionDetail() {
  ...
  const isRegOpen = comp.registerOpen === true || String(comp.registerOpen).toUpperCase() === 'TRUE';
    ...
    <>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
          <div className="glass-panel p-6 md:p-10 rounded-t-3xl border-b-0 relative overflow-hidden">
              ...
              <p className="text-lg text-slate-600 mb-8 max-w-3xl relative z-10">{comp.description}</p>
              
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 bg-white/60 p-6 rounded-2xl border border-white/60 relative z-10 shadow-sm">
          ...
          <div className="bg-white rounded-b-3xl shadow-xl border border-t-0 border-slate-100 overflow-hidden relative">
              <div className="p-6 md:p-10 border-b border-slate-100">
                  ...
                  <div className="markdown-content pl-2 md:pl-12" dangerouslySetInnerHTML={{ __html: comp.rules?.replace(/\n/g, '<br/>') || 'ไม่มีข้อมูลกติกา' }}>
                  </div>
              </div>
              ...
              <div className="p-6 md:p-10">
                  ...
                  <div className="markdown-content pl-2 md:pl-12" dangerouslySetInnerHTML={{ __html: comp.judgingCriteria?.replace(/\n/g, '<br/>') || 'ไม่มีข้อมูลเกณฑ์การตัดสิน' }}>
                  </div>
              </div>
          </div>
      </section>
